...
🆔 ᴜᴘɪ ɪᴅ ➩ <code>@fam</code> [ᴛᴀᴘ ᴛᴏ ᴄᴏᴘʏ]
...
Aᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀɴᴅ ᴍᴀᴋᴇ ᴍᴇ ᴀᴅᴍɪɴ ᴀɴᴅ ᴜsᴇ ᴀʟʟ ғᴇᴀᴛᴜʀᴇs😇</b>"""
    ...
    SOURCE_TXT = """<b>
NOTE:
- ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ʜᴇʀᴇ ◉› :<blockquote><a href="https://t.me/GG_Botz">ᴛᴏᴍ - 🎥 ᴍᴏᴠɪᴇ ʙᴏᴛ</a></blockquote>
